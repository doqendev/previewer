...
'MA': -20, 'AR': -10, 'RC': -5,  'CO': -1,  'OS': -10,  'CH': -5,  'AE': -15, 'EL': -5,  'JA': 5,   'AM': 12,
        ...
        'BR': -3,  'RI': -3,  'RE': 30,  'AD': -10, 'DA': -15,  'AM': -10,
        'MI': -5,  'IC': 0,   'HA': -5,  'AE': -10, 'BA': -10,  'AC': -15,
        'CA': -10, 'AE': -5,  'EA': -6,  'AF': -2,  'FA': -20,  'AH': -2,  'KA': -5,
        'AG': -10, 'GA': -5,  'AI': -5,  'AJ': -8,  'JA': -7,   'AK': -5,  'AL': -5,
        'LA': -5,  'AM': -2,  'MA': -4,  'AN': -5,  'NA': -4,   'AO': -10, 'OA': -10,
        'AP': -3,  'PA': -17, 'AQ': -17, 'QA': -10, 'AR': -7,   'RA': -5,  '': -10,
        'AS': -8,  'SA': -7,  'AT': -22, 'TA': -24, 'AU': -8,   'UA': -8,  '': -8,
        'AV': -30, 'VA': -30, 'AW': -30, 'WA': -30, 'AX': -5,   'XA': -5,  '': -10,
        'AY': -42, 'YA': -42, 'AZ': -7,  'ZA': -7,  '': -10,    '': -10,   '': -10,
        'EB': -5,  'BE': -5,  'EC': -10, 'CE': -5,  'ED': -7,   'DE': -4,  '': -10,
        'EE': -10, 'EF': -10, 'FE': -10, 'EG': -10, 'EH': -8,   'HE': -6,  '': -10,
        'EI': -10, 'EJ': -10, 'EK': -5,  'LE': -5,  'EM': -7,   'ME': -7,  '': -10,
        'EN': -5,  'KE': -5,  'NE': -2,  '': -10,   '': -10,    '': -10,   '': -10,
        'EO': -10, 'OE': -3,  'EP': -7,  'PE': -2,  'EQ': -10,  'QE': -2,  '': -10,
        'ER': -5,  'RE': -5,  'ES': -10, 'SE': -2,  'ET': -7,   'TE': -5,  '': -10,
        'EU': -8,  'UE': -1,  'EV': -8,  'VE': -5,  'EW': -7,   'WE': -6,  '': -10,
        'EX': -7,  'XE': -5,  'EY': -7,  'YE': -5,  'EZ': -7,   'ZE': -5,  '': -10,
        'DY': -20, 'YL': -5,  'BO': -3,  'OC': -3,  'CO': -5,   'FO': -10, '': -10,
        'OG': -3,  'GO': -3,  'HO': -2,  'OH': -2,  'OI': -2,   'OJ': -2,  '': -10,
        'JO': -1,  'KO': -15, 'LO': -10, 'OM': -3,  'MO': -3,   'OL': -2,  '': -10,
        'OO': -4,  'OP': -3,  'PO': -4,  'OQ': -3,  'QO': -2,   '': -10,
        'OR': -2,  'RO': -7,  'OS': -4,  'SO': -3,  'OT': -8,   'TO': -9,
        'OU': -3,  'OV': -11, 'VO': -11, 'OW': -10, 'WO': -10,  'OX': -15,
        'XO': -15, 'OY': -13, 'YO': -13, 'OZ': -8,  'ZO': -10,  'BU': -4,
        'UC': -4,  'CU': -7,  'DU': -4,  'UD': -1,  'HU': -1,   'UI': -1,
        'IU': 4,   'FU': -10, 'UG': -3,  'GU': -2,  'UF': -2,   'IU': 1,
        'UJ': -2,  'JU': -2,  'KU': -10, 'LU': -12, 'UK': -3,   '': -10,
        'UM': -2,  'MU': -3,  'PU': -3,  'UQ': -2,  'QU': -3,   'RU': -5,
        'US': -3,  'SU': -3,  'UT': -3,  'TU': -5,  'UV': -4,   'VU': -5,
        'UW': -4,  'WU': -6,  'UX': -4,  'XU': -4,  'UY': -3,   'YU': -5,
        'UZ': -2,  'ZU': -4,  'BI': -3,  'DI': -5,  'FI': -6,   'GI': -10,
        'HI': -3,  'JI': -5,  'KI': -5,  'LI': -10, 'IN': -1,   'NI': -3,
        'PI': -5,  'QI': -5,  'SI': -3,  'IR': 1,   'TI': -10,  'IV': -1,
        'VI': -5,  'IW': -3,  'WI': -5,  'XI': -5,  'YI': -5,   'IZ': 1,
        'ZI': -5,  'TH': -5,  'HS': -3,  'SH': -5,  'PH': -3,   'HW': -5,
        'WH': -5,  'ST': -10, 'RC': -7,  'CR': -5,  'RD': -3,
        'DR': -2,  'RG': -8,  'GR': -3,  'PR': -5,  'RT': -5,
        'TR': -5,  'RL': -5,  'LL': -5,  'LN': -5,  'NN': -2,   'NT': -2,
        'TT': -5,  'BB': -5,  'OA': -20, 'AS': -15, 'RS': -8,   'HN': -3, '': -5,
};
